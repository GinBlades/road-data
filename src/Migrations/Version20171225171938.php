 ...
 */
class Version20171225171938 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE road_event (id INT AUTO_INCREMENT NOT NULL, last_updated DATETIME NOT NULL, latitude DOUBLE PRECISION NOT NULL, longitude DOUBLE PRECISION NOT NULL, planned_end_date DATETIME DEFAULT NULL, reported DATETIME NOT NULL, start_date DATETIME NOT NULL, dot_id VARCHAR(255) NOT NULL, region_name VARCHAR(255) NOT NULL, county_name VARCHAR(255) NOT NULL, severity VARCHAR(255) NOT NULL, roadway_name VARCHAR(255) NOT NULL, direction_of_travel VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, location VARCHAR(255) NOT NULL, lanes_affected VARCHAR(255) NOT NULL, lanes_status VARCHAR(255) DEFAULT NULL, lcs_entries VARCHAR(255) DEFAULT NULL, navteq_link_id VARCHAR(255) DEFAULT NULL, primary_location VARCHAR(255) DEFAULT NULL, secondary_location VARCHAR(255) DEFAULT NULL, first_article_city VARCHAR(255) DEFAULT NULL, second_city VARCHAR(255) DEFAULT NULL, event_type VARCHAR(255) NOT NULL, event_sub_type VARCHAR(255) NOT NULL, map_encoded_polyline VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE roadway (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, sort_order INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
